	...
	<div class="card-body">
		<table class="table align-middle border rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
          ...
          <th class="min-w-100px"><span style="color:rgb(68, 235, 62);">ID</span></th>
					<th class="min-w-100px"><span style="color:rgb(68, 235, 62);">Name Lesson</span></th>
					<th class="min-w-100px"><span style="color:rgb(68, 235, 62);">Link</span></th>
        ...
        @foreach($lesson as $item)
          <tr class="odd">
            ...
            <td class="min-w-100px">{{ $item->name_lesson }}</td>
            <td class="min-w-100px">{{ $item->link }}</td>
            <td class="min-w-100px"><a href="{{ route('admin.lesson.delete', ['id'=>$item->id]) }}">Delete</a></td>
            <td class="min-w-100px"><a href="{{ route('admin.lesson.edit', ['id'=>$item->id]) }}">Edit</a></td>
          </tr>
        @endforeach
			</tbody>
		</table>
