            ...
            <form action="{{ route('admin.comment.update',['id'=>$comment->id]) }}" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <textarea type="text" class="form-control form-control-solid" name="comment" placeholder="Vui lòng nhập bình luận">{{ old('comment',$comment->comment) }}</textarea>
                <div>
                ...
                <div>
                  ...
                  <select class="form-select" aria-label="Select example" name="movie_id">
                    <option>{{ $comment->movie_id }}</option>
