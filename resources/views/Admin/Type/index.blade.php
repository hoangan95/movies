	...
	<div class="card-body">
        ...
        @foreach($type as $item)
          <tr class="odd">
            ...
            <td class="min-w-100px">{{ $item->name_type }}</td>
            <td class="min-w-100px"><a href="{{ route('admin.type.delete', ['id'=>$item->id]) }}">Delete</a></td>
            <td class="min-w-100px"><a href="{{ route('admin.type.edit', ['id'=>$item->id]) }}">Edit</a></td>
          </tr>
        @endforeach
			</tbody>
		</table>
