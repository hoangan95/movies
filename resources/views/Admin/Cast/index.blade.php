        ...
        @foreach($cast as $item)
          <tr class="odd">
            ...
            <td class="min-w-100px">{!! Str::limit($item->intro, 100) !!}</td>      
			      <td class="min-w-100px"><a href="{{ route('admin.cast.delete', ['id'=>$item->id]) }}">Delete</a></td>
            <td class="min-w-100px"><a href="{{ route('admin.cast.edit', ['id'=>$item->id]) }}">Edit</a></td>
          </tr>
        @endforeach
			</tbody>
		</table>
